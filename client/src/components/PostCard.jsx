...
export default function PostCard({ post }) {
  return (
    <div className=" shadow-darkBlueGlow dark:shadow-yellowGlow group relative w-full  hover:border-2 h-[400px] overflow-hidden rounded-lg transition-all mx-auto">
